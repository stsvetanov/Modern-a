...
# Документация за SELENIUM: https://pypi.org/project/selenium/
import time
import pandas as pd

# За да използваме SELENIUM трябва да инсталираме допълнително един
# от следните драйвери, в зависимост от браузъра,с който искаме да работим:
...
# executable_path не е задаължителнода се указва, освен ако драйверът не е инсталиран на НЕОБИЧАЙНО място
...
# # # sleep for 30s
    ...
    for result in results:
        ...
        alt=info2.get_attribute("alt").split(",") # alt става списък
        # alt[0] е марката - имаме я в таг a => пропуснем

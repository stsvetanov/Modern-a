...
#text2 = 'Task1/DifferentBoringTextFile-ExtraLine.txt' # 2. Вариант - Има допълнителна линия и разлики
#text2 = 'Task1/DifferentBoringTextFile-SameLength.txt' # 3. Вариант - Еднаква дължина на файла но има и разлики
